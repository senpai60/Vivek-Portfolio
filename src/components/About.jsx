...
import PortraitHover from "./PortraitHover";
  ...
  useEffect(() => {
    ...
    let ctx = gsap.context(() => {
      if (statementRef.current) {
        statementSplit = new SplitType(statementRef.current, {
          types: "lines",
        });
        gsap.fromTo(
  ...
  return (
    ...
    >
      ...
      <div className="about-grid">
            ...
            {details.map((d, i) => (
              <div
                ...
                style={{
                  ...
                  borderLeft:
                    i % 2 === 1 ? "1px solid var(--accent-color)" : "none",
        ...
        {/* CENTER — Portrait with shader hover */}
        ...
        <div className="about-right">
          <div className="about-workspace">
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(to bottom, rgba(11,11,11,0.4) 0%, transparent 50%)",
                pointerEvents: "none",
              }}
            />
            <div
          ...
          <div className="about-right-bio">
            ...
            >
              Vivek Satloniya is a full-stack developer specialising in the MERN
              stack and interactive web experiences. His work combines modern
              web technologies with motion and visual design to create digital
              products that are both functional and visually compelling.
            </div>
            <p
              style={{
                fontFamily: "var(--font-heading)",
